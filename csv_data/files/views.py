...
def profile_upload(request):
        ...
        # data_set = csv_file.read().decode('UTF-8')
            ...
            engine = create_engine('postgresql://postgres:12345@localhost:5432/ipl_cricket')
...
def maximum_player_match(request):
    ...
    queryset = profile_data.objects.values("player_of_match")
...
def toss_winner(request):
    ...
    queryset = profile_data.objects.values("toss_winner")
...
def winner(request):
    ...
    queryset = profile_data.objects.values("winner")
